...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Ubah Ijin Absen</div>
        <div class="right"></div>
    </div>
@endsection
...
@section('content')
    <div class="row" style="margin-top: 70px">
        <div class="col">
            <form method="POST" action="/ijinabsen/{{ $dataijin->kode_ijin }}/update" id="frmIjin">
                @csrf
                ...
                <div class="form-group">
                    <input type="text" id="jml_hari" name="keterangan" class="form-control" autocomplete="off"
                        placeholder="Keterangan" readonly>
                </div>
                <div class="form-group">
                    <input type="text" id="keterangan" value="{{ $dataijin->keterangan }}" autocomplete="off"
