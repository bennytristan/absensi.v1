...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Perubahan Pengajuan Cuti</div>
        <div class="right"></div>
    </div>
@endsection
...
@section('content')
    <div class="row" style="margin-top: 70px">
        <div class="col">
            <form method="POST" action="/ijincuti/{{ $dataijin->kode_ijin }}/update" id="frmijin">
                @csrf
                ...
                <div class="form-group">
                    <select name="kode_cuti" id="kode_cuti" class="form-control selectmaterialize">
                        ...
                        @foreach ($mastercuti as $d)
                            <option {{ $dataijin->kode_cuti == $d->kode_cuti ? 'selected' : '' }}
