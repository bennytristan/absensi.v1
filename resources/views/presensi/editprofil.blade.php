...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">PERUBAHAN DATA PROFIL</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
@endsection
        ...
        <div class="col">
            ...
            @error('foto')
                <div class="alert alert-warning" style="text-align: center">
                    <p>Periksa Kembali Format Foto harus png,jpg,jpeg atau Max 1MB</p>
                @enderror
            </div>
        </div>
    </div>

    <form action="/presensi/{{ $karyawan->nik }}/updateprofil" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="col">
                ...
                <label for="fileuploadInput">
                    <span>
                        <strong>
                            ...
                            <i>Maksimal Foto berukuran 1024kb</i>
                        </strong>
                    </span>
                </label>
            </div>
