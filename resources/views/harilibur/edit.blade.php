    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" class="form-control" value="{{ $harilibur->kode_libur }}" id="kode_libur"
            ...
            <div class="row">
                <div class="col-12">
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $harilibur->tgl_libur }}"
                            id="tanggal_libur" placeholder="Tanggal Libur" name="tanggal_libur" autocomplete="off">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="form-group mb-3">
                <select name="kode_cabang" id="kode_cabang" class="form-select">
                    ...
                    @foreach ($cabang as $d)
                        <option {{ ($harilibur->kode_cabang == $d->kode_cabang) != null ? 'selected' : '' }}
                            value="{{ $d->kode_cabang }}">
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" class="form-control" value="{{ $harilibur->keterangan }}" id="keterangan"
