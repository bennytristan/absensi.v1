...
@section('content')
    <div class="page-header d-print-none">
        ...
        </div>@extends('layout.admin.tabler')
    @section('content')
        <div class="page-header d-print-none">
            <div class="container-xl">
                <div class="row g-2 align-items-center">
                                        ...
                                        <div class="col-12">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $lok_kantor->lokasi_kantor }}"
                                                    class="form-control" id="lokasi_kantor"
                                                    placeholder="Diisi Latitude dan Longtitude Kantor" name="lokasi_kantor">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ $lok_kantor->radius }}" class="form-control"
                                                    id="radius" placeholder="Diisi Radius Kantor" name="radius">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
