                                                    ...
                                                    <td>
                                                        <div class="d-flex text-center">
                                                            <a href="#" class="edit badge bg-info badge-sm"
                                                                id_user="{{ $d->id }}" data-bs-toggle="tooltip"
                        ...
                        <div class="row mt-1">
                            <div class="col-12">
                                <div class="input-icon">
                                    ...
                                    <input type="text" value="" class="form-control" id="nama_user"
                            ...
                            <div class="col-12">
                                <div class="input-icon">
                                    ...
                                    <input type="text" value="" class="form-control" id="email"
                                        name="email" placeholder="email.pengguna@gmail.com" autocomplete="off">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <select name="kode_cabang" id="kode_cabang" class="form-select">
                                        ...
                                        @foreach ($cabang as $d)
                                            <option value="{{ $d->kode_cabang }}">{{ ucwords($d->nama_cabang) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
