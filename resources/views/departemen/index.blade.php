                                            ...
                                            <div class="col-10">
                                                <div class="form-group">
                                                    <input type="text" name="nama_dept" id="nama_dept"
                                                        ...
                                                        value="{{ Request('nama_dept') }}" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-2">
                                                <div class="form-group">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/departemen/store" method="POST" id="frmDept">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" class="form-control" id="kode_dept"
                                        placeholder="Kode Departemen" name="kode_dept">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" class="form-control" id="nama_dept"
